 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.045 // (mm) Distance from real junction edge (calculated formula d= 0.4 * (Jerk ^2)/Acceleration)(0.043 = 0.4 * 9*9 / 750) Values based on online starting base settings

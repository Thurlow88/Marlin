...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Ender 3 V2
  #define DEFAULT_bedKp 155.23
  #define DEFAULT_bedKi  30.32
  #define DEFAULT_bedKd 529.86
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.035 // (mm) Distance from real junction edge (calculated formula d= 0.4 * (Jerk ^2)/Acceleration)(0.043 = 0.4 * 9*9 / 750) Values based on online starting base settings
